    ...
    <header className="bg-white shadow-md">
      ...
      <section className="flex items-center justify-between px-4 py-3 mx-auto lg:px-20 max-w-screen-2xl">
        ...
        <div className="flex items-center">
          <Link
            to="/report-complaint"
            className="hidden px-4 py-2 text-sm font-medium text-white rounded-md xl:inline-block bg-dark-green hover:bg-green-700 focus:outline-none"
          >
            Report a complaint
          </Link>
          <button
            className="block text-gray-500 xl:hidden hover:text-gray-600 focus:text-gray-600 focus:outline-none"
            onClick={toggleMobileMenu}
          >
            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
              {mobileMenuState.isOpen ? (
